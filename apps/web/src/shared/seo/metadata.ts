...
export async function fetchMetadata({
    ...
    let title = 'FinFlow – Захист ваших ставок';
    let description =
        'FinFlow – надійний сервіс для захисту та управління вашими ставками. Ми створюємо безпечні та ефективні рішення для вашого бізнесу.';
